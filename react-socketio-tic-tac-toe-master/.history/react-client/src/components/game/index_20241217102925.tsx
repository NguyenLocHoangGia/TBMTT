...
const X = styled.span`
  font-size: 100px;
  color: #e74c3c;  /* Chỉnh màu sắc */
  font-weight: bold;  /* Chỉnh kiểu chữ */
  transform: rotate(45deg);  /* Xoay dấu X để tạo hiệu ứng */
  display: inline-block;
`;

const O = styled.span`
  font-size: 100px;
  color: #2ecc71;  /* Chỉnh màu sắc */
  font-weight: bold;
  border: 3px solid #2ecc71;  /* Thêm viền xung quanh O */
  border-radius: 50%;
  padding: 50px;
  display: inline-block;
`;
